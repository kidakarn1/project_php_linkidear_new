<html>
    ...
    $sql = "select * from customer where CUS_CHECK_DEL = '1'";
    $res = $conn->query($sql);
    ...
    <body>
        ...
        function search($conn, $search) {
            $sql2 = "select * from customer where (CUS_FNAME  like '%$search%'  or CUS_LNAME  like ' %$search%'  or  CUS_PHONE  like '%$search%') and  CUS_CHECK_DEL = '1'";
            $res2 = $conn->query($sql2);
            return $res2;
        }

        function delete($conn, $ID_CHECKS) {
            $sql1 = "update customer set  CUS_CHECK_DEL = '0' where CUS_PHONE='$ID_CHECKS'";
