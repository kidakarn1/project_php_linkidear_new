...
?>
<center>
    <form class="form-horizontal" method="post" action="update_lable.php">
        ...
        <div class="hide_naja">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="phone1" name="phone" value="<?php echo $row['CUS_PHONE']; ?>" placeholder="เบอร์โทร" readonly/>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <div id="cat_name">
                    <select class="form-control" id="cat_name1" name="cat_id">
                        <?php
                        while ($row_category = $res_category->fetch_array()) {
                            ?>
